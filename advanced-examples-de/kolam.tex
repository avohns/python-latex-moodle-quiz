...
% Bitte beachten Sie: Für dieses Beispiel werden die png-Dateien im Unterordner /kolam verwendet, die mit dem Skript kolam.py erstellt/angepasst werden können.
\begin{python}
